...
public class Base64Converter {
    ...
    public void encode_to_base64() {
        try {
            encode("config.dat", fw.getDefaultDirectory() + "\\Library\\config.dat", IS_CHUNKED);
        } catch (Exception ec) {
    ...
    public void decode_from_base64() {
        try {
            decode(fw.getDefaultDirectory() + "\\Library\\config.dat", fw.getDefaultDirectory() + "\\Library\\config_temp.dat");
        } catch (Exception ec) {
